...
for i in range(len(params.pos_rcv)):
    ...
    filtered_IR = filtering.filter_mono_IR(
        receiver_channels[i], filters, params.bit_depth, params.fs, filename_appendix=filename_appendix, write_wave=write_IR_file, enable_adaptive_gain=False, visualize=visualize, verbose=verbose)
