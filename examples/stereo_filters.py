...
filtered_IR_right, filtered_IR_left = filtering.filter_stereo_IR(receiver_channel_r, receiver_channel_l, filters_r, filters_l,
                                                                 bit_depth, fs, filename_appendix=filename_appendix, write_wave=write_IR_file,
                                                                 enable_adaptive_gain=False, verbose=verbose, visualize=visualize)
