...
filtered_IR_right, filtered_IR_left = gIR.generate_stereo_IR(receiver_channel_r, receiver_channel_l,
                    filters_r, filters_l, bit_depth, fs, enable_adaptive_gain=False, verbose=verbose, visualize=visualize)
