...
class CharacteristicFilter(FilterStrategy):
    ...
    def interpolate_frequency_response(freq_response, plot):
        ...
        :param freq_response Frequency response model array
        :param plot If True, plot frequency response graph.
        :returns Interpolation function f.
        '''
    ...
    def apply_characteristic(self, RIR):
        ...
        :param RIRs Room impulse responses generated by gpuRIR.
        :returns Processed RIRs.
        '''
